...
namespace Formulas.Core.Steps.Trigonometry
{
    public class PythagorasResolution
    {
        ...
        {            
            ...
            {
                steps.AddRange(IncogniteAResolution());
            }
            else if (_calculation.Incognite == "B")
            {
                steps.AddRange(IncogniteBResolution());
            }
            else
            {
                steps.AddRange(IncogniteCResolution());
            }
        ...
        private List<string> IncogniteAResolution()
        {
            List<string> steps = new List<string>();
        ...
        private List<string> IncogniteBResolution()
        {
            List<string> steps = new List<string>();
        ...
        private List<string> IncogniteCResolution()
        {
            List<string> steps = new List<string>();
